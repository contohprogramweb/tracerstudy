...
| The auto-detection mechanism exists in the config/application.php file.
...
|
| Note: This will be added to all URLs except when using 'raw' output.
*/
$config['url_suffix'] = '';
...
|	             files generated for the same page separately.
|	'query_string' = Enabled, take only the specified query parameters
|	                 into account. Separate the parameter names with commas.
|
*/
...
$config['sess_cookie_name'] = 'ci_tracer_study_session';
...
| meaning to replace \r\n, \r\n, \n characters with the PHP_EOL value.
|
...
| compression to work, nothing can be output before the output class is
| called, except for doctype tags - it's not a bug with the compression.
|
*/
