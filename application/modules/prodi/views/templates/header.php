...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <h4><i class="bi bi-graph-up"></i> Tracer Study Prodi</h4>
        </div>
        <ul class="sidebar-menu">
            <li><a href="<?= base_url('prodi/dashboard') ?>" class="<?= ($this->uri->segment(2) == 'dashboard') ? 'active' : '' ?>"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
